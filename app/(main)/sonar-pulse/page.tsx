...
import {Avatar, AvatarProps} from "@logi-x/avatar";
import {Button} from "@logi-x/button";
import {Spacer} from "@logi-x/spacer";
import {Tooltip} from "@logi-x/tooltip";
import {clamp} from "@logi-x/shared-utils";
// import {usePostHog} from "posthog-js/react";
//
import {sectionWrapper, titleWrapper, title, subtitle} from "@/components/primitives";

import {FeaturesGrid} from "./features-grid";

import {PlusLinearIcon} from "@/components/icons/linear";
import {HeartBoldIcon} from "@/components/icons/bold";
// import {OpenCollectiveIcon, PatreonIcon} from "@/components/icons";
import {Sponsor, SPONSOR_TIERS, SPONSOR_COLORS, getTier, mockData} from "@/libs/docs/sponsors";
...
const supportAccounts = [
  {
    ...
    icon: <PlusLinearIcon className="text-pink-500" />,
...
export const Support: FC<SupportProps> = ({sponsors = mockData}) => {
